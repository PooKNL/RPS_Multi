...
describe('<GamesContainer />', () => {
  const container = shallow(<GamesContainer recipes={ recipes } />)
  ...
  it('renders all recipes as a GameItem', () => {
    expect(container).to.have.exactly(recipes.length).descendants(GameItem)
  })
})
